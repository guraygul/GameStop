...
final class DetailGameCell: UICollectionViewCell {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            screenshotsLabel.topAnchor.constraint(equalTo: gameLabel.bottomAnchor, constant: 16),
            ...
            screenshotsCollectionView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -16)
        ])
    }
